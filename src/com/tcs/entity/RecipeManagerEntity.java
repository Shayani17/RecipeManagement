...
public class RecipeManagerEntity {
	...
	public String toString() {
		return " [recipe_id=" + recipe_id + ", recipe_name=" + recipe_name + ", recipe_category=" + recipe_category
				+ ", recipe_servering=" + recipe_servering + ", recipe_ingredient=" + recipe_ingredient
				+ ", recipe_instruction=" + recipe_instruction + ", created_date=" + created_date + "]";
	}
